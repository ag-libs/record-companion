...
public class BuilderGenerator {
    ...
    private MethodSpec generateWithMethod(ClassName recordClass, ClassName companionClass, List<? extends RecordComponentElement> components) {
        ...
        ParameterizedTypeName updaterConsumerType = ParameterizedTypeName.get(consumerType, companionClass.nestedClass("Updater"));
        ...
        return MethodSpec.methodBuilder("with")
            ...
            .addJavadoc("@param updater a consumer that receives an updater initialized with the existing record's values\n")
